...
<div class="left-side-bar" id="sidebar">
   <a id="inform" href="<%=application.getContextPath()%>/">메인</a>
   <a href="<%=application.getContextPath()%>/main/content">도착시간 예측</a>
     <form action="predict" method="post">
    	...
    	<tr>
    	<th><label for="statmnt_tm">시간대 선택   : </label><br/></th>
		<th><select id="statmnt_tm" name="statmnt_tm">
		...
		<th><select id="jurisd" name="jurisd">
		...
		<th><select id="conscs" name="conscs">
		...
		<th><select id="occurplc" name="occurplc">
       ...
       <a href="<%=application.getContextPath()%>/main/content2">관할범위 예측</a>
         <form action="predict2" method="post">
			...
			<th><input type="text" id="safe_senter" name="safe_senter" value="대화119안전센터"></th>
			</tr>						    	
		    <tr>
		    <th><label for="move_tm">소요시간 입력 : </label></th>
			<th><input type="text" id="move_tm" name="move_tm" value="5.0"></th>
			</tr>
			<tr>
